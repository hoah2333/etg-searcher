export default {
    ...
    Meatbun: {
        ...
        locale: {
            ...
            notes: "一次性道具，使用后恢复 1 颗心{{PICKUP:Heart}}，并且在下次受伤前伤害+100%。\r\n{{SYSTEM:co-op}}下，队友受伤也会失去伤害加成效果。",
    ...
    Medkit: {
        ...
        locale: {
            ...
            notes: "一次性道具，使用后恢复 4 颗心{{PICKUP:Heart}}{{PICKUP:Heart}}{{PICKUP:Heart}}{{PICKUP:Heart}}。\r\n对{{GUNGEONEER:The Robot}}无效。",
            trivia: "物品说明引用自非牟利团体“无国界医生组织”，调皮地改成了“无证件医生组织”。\r\n“带有小精灵的碎片”引用自《塞尔达传说》，把小精灵作为恢复生命值的道具。",
    ...
    "Proximity Mine": {
        ...
        locale: {
            ...
            notes: "使用后放置一个地雷，在敌人靠近时自动引爆，造成60点伤害。\r\n{{ENEMY:Mimic}}靠近不会引爆。",
            trivia: "外观引用自N64游戏《黄金眼007（GoldenEye 007）》：\r\n[(~data/Proximity_Mine_Goldeneye_N64.jpg)]",
    ...
    "Napalm Strike": {
        ...
        locale: {
            ...
            trivia: "物品简介“气味太好了（Smells Great!）”引用自电影《现代启示录（Apocalypse Now）》的台词“我喜欢清晨的汽油味（I love the smell of napalm in the morning）”。",
    ...
    "iBomb Companion App": {
        ...
        locale: {
            ...
            trivia: "物品简介“用于引爆的一个应用程序（One For That）”引用自广告语“有一个相关的应用程序（There's an App for that!）”。",
    ...
    "Hidden Compartment": {
        ...
        locale: {
            ...
            trivia: "物品说明中提到的被帝国发现私藏不合法物品，引用自《星球大战（Star Wars）》里{韩索罗（Han Solo）}走私物品被帝国抓到。",
    ...
    "Clown Mask": {
        ...
        locale: {
            ...
            keyword:
                "xiaochoumianjuxiaochoushouhuori2 xcmj xc shr2 小醜麵具 小醜 收獲日2 小丑 收获日2",
            unlock: "在{{NPC:Bello}}的商店获得，可以{{SYSTEM:Steal}}，或者开枪气跑{{NPC:Bello}}（该道具会留下）"
        },
        sell: 30,
    ...
    "Shadow Clone": {
        ...
        locale: {
            ...
            trivia: "引用自动漫《火影忍者（Naruto）》中漩涡鸣人（Naruto Uzumaki）最喜欢的忍术。\r\n道具图标是忍者卷轴。",
    ...
    "Explosive Decoy": {
        ...
        locale: {
            ...
            notes: "使用后放置一个诱饵吸引敌人，受到一定伤害或过 11 秒后爆炸，对附近的敌人造成 30 点伤害。\r\n可以用来{{SYSTEM:Steal}}，放置 11 秒后会自动爆炸，记得在这个时间内偷。\r\n如果同时拥有{{ITEM:Ring of Triggers}}，诱饵会在放置时马上爆炸，对玩家造成伤害。",
    ...
    "Melted Rock": {
        ...
        locale: {
            ...
            trivia: "引用自《废土之王（Nuclear Throne）》的角色{融化者（Melting）}，他的主动技能就是尸爆。",
    ...
    "Smoke Bomb": {
        ...
        locale: {
            ...
            name: "烟雾弹",
            tips: "使用后敌人暂时看不见你。\r\n可以用来{{SYSTEM:Steal}}。",
            trivia: "物品简介“消失！（Vanish!）”引用自电影《忍者神龟2》的台词“忍者，消失！（Ninja, vanish!）”。",
    ...
    "Fortune's Favor": {
        ...
        locale: {
            ...
            trivia: "引用自《合金装备2》的角色{Fortune}，据说她拥有超自然的运气，但实际上是拥有一个特殊的设备，能让子弹偏移，把手榴弹变成哑弹。",
    ...
    "Crisis Stone": {
        ...
        locale: {
            ...
            trivia: "物品名和“Reload”的声音引用自南梦宫（Namco）的《化解危机（Time Crisis）》系列，装弹前要先掩护好，以免被敌人的子弹打到。",
    ...
    "Portable Table Device": {
        ...
        locale: {
            ...
            notes: "使用后生成一张方桌，除了尺寸小一些，和地图上的普通桌子没有区别，一样可以掀桌，受到一定伤害后破坏。\r\n满能量时可使用3次，用完后需重新充能。\r\n- 配合{{SYSTEM:Table Tech}}道具使用效果更佳\r\n- 可以用来卡住{{BOSS:Ammoconda}}",
    ...
    "+1 Bullets": {
        ...
        locale: {
            ...
            name: "子弹+1",
            tips: "增加 25% 伤害",
            trivia: "引用自《龙与地下城》，+1 的魔法物品有更高的伤害，物品简介“子弹属性 +1（+1 To Bullet）”类似于“伤害加成 +1（+1 to damage）”，和各种{{SYSTEM:Guon Stones}}的组合引用自{伊奥恩之石（Ioun Stone）}，这些魔法石能在主人的头顶上漂浮着，赋予他们各种特殊的力量。",
    ...
    "Shock Rounds": {
        ...
        locale: {
            ...
            trivia: "物品说明“闪电阿里斯泰尔（Alistair, the Thunderbolt）”引用自在《红侠乔伊（Viewtiful Joe）》和《鬼泣（Devil May Cry）》中都有出场的复仇者阿拉斯托尔（Alastor），具有雷电属性。",
    ...
    "Hungry Bullets": {
        ...
        locale: {
            ...
            notes: "射出可以吞噬敌人子弹的蓝色子弹，每 3.3333 秒可触发一次。\r\n一次射出越多子弹的枪效果越好，如霰弹枪。\r\n{{GUN:Phoenix}}喷出的近距离火焰如果触发该效果，也可以吞噬敌人的子弹。",
            trivia: "物品外观和简介“好饿好饿（Hungry Hungry）”引用自在美国家喻户晓的桌游《饥饿河马（Hungry Hungry Hippos）》，玩家控制 4 匹河马吃弹珠，收集弹珠最多的玩家获胜。\r\n[(~data/Hungry_Hungry_Hippos.jpg)]",
    ...
    "Magic Bullets": {
        ...
        locale: {
            ...
            trivia: "物品简介“简易的高级魔法（Sufficiently Advanced）”引用自亚瑟·查理斯·克拉克（Arthur Charles Clarke）提出的{克拉克基本定律（Clarke's three laws）}的第三定律：\r\n<g>Any {sufficiently advanced} technology is indistinguishable from magic.<br/>在任何一项足够先进的技术和魔法之间，我们无法作出区分。</g>",
    ...
    "Shadow Bullets": {
        ...
        locale: {
            ...
            notes: "每次射击有 15% 概率额外射出一颗子弹。\r\n额外射出的子弹的弹道不会被改变，如{{ITEM:Helix Bullets}}{{ITEM:Remote Bullets}}。",
            trivia: "物品简介“双击（Double Tap）”引用自现实生活中士兵和刺客常用的一种枪战技巧，连续两次快速点射，提高打中目标的概率。这种技巧有个典型的应用是近战枪技{莫桑比克射击法（Mozambique Drill）}，先向目标身躯快速打两枪（Double tap），然后迅速向上往目标头部打一枪（Head shot）。前两枪的目的是为了更快更准确地击中目标，削弱目标的反抗能力，打胸部总比打头部容易，第三枪补射直接破坏大脑，确保击杀目标。",
    ...
    "Bloody 9mm": {
        ...
        locale: {
            ...
            notes: "每秒有 8% 概率射出一颗弹速快、带((跟踪))((穿透))((反弹))效果的子弹，在房间里飞来飞去对敌人造成伤害。\r\n射击频率越低概率越大，如蓄满力的{{GUN:BSG}}几乎 100% 触发。",
            trivia: "引用自 Joe Abercrombie 的奇幻小说《The First Law》的主角 Logen Ninefingers，外号{The Bloody Nine}。",
    ...
    "Bionic Leg": {
        ...
        locale: {
            ...
            name: "仿生腿",
            tips: "+1.5 移速。\r\n获得一个{{PICKUP:Armor}}。",
            trivia: "物品简介“更像是机器而不是人类（More Machine Than Man）”引用自《星球大战6：绝地归来》的台词，阿纳金（Anakin）堕入邪恶，欧比旺（Obi-Wan）说：\r\n<g>he's more machine now than man. Twisted and evil.\r\n他现在更像是机器而不是人类，扭曲而邪恶。</g>",
    ...
    "Shotga Cola": {
        ...
        locale: {
            ...
            name: "霰弹可乐",
            tips: "+1.5 移速",
            trivia: "引用自德国希尔德布兰德巧克力厂 1936 年出品的黑巧克力{Scho-Ka-Kola}，含有大量咖啡因，有强烈的提神功效。二战期间 Scho-Ka-Kola 是德国国防军标准口粮之一。Scho-Ka-Kola 取自{Schokolade（巧克力）}{Kaffee（咖啡）}{Kolanuss（可乐果）}三个词的前缀。\r\n物品说明“把盖子留着”引用自《辐射（Fallout）》系列的核子可乐（Nuka Cola），它的瓶盖是废土上的通用货币。",
    ...
    "Lichy Trigger Finger": {
        ...
        locale: {
            ...
            name: "死尸扳机指",
            tips: "+25% 射击频率",
            trivia: "引用自短语{itchy trigger finger（扳机手指发痒）}，指手指按在扳机上，就会有很强的欲望扣动扳机，难以控制地做出意料之外的事情。",
    ...
    "Enraging Photo": {
        ...
        locale: {
            ...
            notes: "受伤后弹夹自动装满，短时间内伤害翻倍。\r\n{{GUNGEONEER:The Convict}}的初始被动道具。\r\n可以带进角色的过去任务。",
            trivia: "照片上的人是{{BOSS:Black Stache}}，{{GUNGEONEER:The Convict}}过去任务里的 BOSS，背叛{{GUNGEONEER:The Convict}}为帝国效力。\r\n物品简介“不要相信他的谎言（Don't Believe His Lies）”引用自电影《记忆碎片（Memento）》，主角有一张拍立得照片，上面写着这句话。",
    ...
    Eyepatch: {
        ...
        locale: {
            ...
            trivia: "物品说明引用自北欧神话中的众神之王{奥丁（Odin）}，他用右眼换取智慧之泉，获得鲁纳斯（Runes）的智慧，经常以戴眼罩的形象出现。",
    ...
    "Amulet of the Pit Lord": {
        ...
        locale: {
            ...
            name: "深坑之王的护身符",
            tips: "{免疫}((掉落))伤害",
            trivia: "引用自万智牌{Lord of the Pit（坑之王）}，卡的效果“要么牺牲一个其它生物，要么受到 7 点伤害”对应该道具的解锁方法“推 100 个敌人掉坑”，（获得后）掉坑就可以不受伤害。",
    ...
    Unity: {
        ...
        locale: {
            ...
            trivia: "物品简介“力量合二为一（Our Powers Combined）”引用自环保主意动画影集《地球超人（Captain Planet）》（港译《星球队长》），拯救世界的环保英雄，必须集合5个戒指的力量才会出现。",
    ...
    "Cloranthy Ring": {
        ...
        locale: {
            ...
            name: "克罗兰溪戒指",
            tips: "+20% 翻滚速度，减少翻滚硬直",
            trivia: "引用自《黑暗之魂》的同名道具{ClorantHy Ring（绿花戒指）}，在黑魂中，翻滚也是重要的移动和躲避敌人攻击的方式，翻滚会消耗精力，而绿花戒指可以提升精力的恢复速度。\r\n其实效果更像黑魂中另一个道具{Dark Wood Grain Ring（暗沉木纹戒指）}，改变翻滚的动作，加快翻滚帧数，缩短硬直帧数。",
    ...
    "Gundromeda Strain": {
        ...
        locale: {
            ...
            trivia: "物品图标和效果引用自游戏《废土之王（Nuclear Throne）》的变异技能{Scarier Face}（效果：敌人减少 20% 最大生命）。\r\n图标外观很像病毒{噬菌体（Bacteriophage）}。\r\n物品说明引用自电影《The Andromeda Strain（天外来菌）》",
    ...
    Crutch: {
        ...
        locale: {
            ...
            name: "拐杖",
            tips: "子弹带轻微((跟踪))效果",
            trivia: "在游戏中出现拐杖相关的物品，通常对技术要求低、同时效果和能力还不错。物品简介“你需要它（You Need It）”是在鄙视我吗？",
    ...
    Spice: {
        ...
        locale: {
            ...
            trivia: "引用自《沙丘（Dune）》系列小说，香料是一种高度成瘾的药物，可以提高超感能力和延长寿命，但一旦使用就不能停下，停止使用会致命。",
    ...
    "Liquid Valkyrie": {
        ...
        locale: {
            ...
            trivia: "引用自《马克思佩恩（Max Payne）》增强士兵能力的药品{Valkyr}，但最后会让人精神失常，残暴杀人。\r\n物品说明中强调“几乎没有副作用（with few side effects）”hhh！",
    ...
    "Bloody Eye": {
        ...
        locale: {
            ...
            trivia: "引用自动画片《星际牛仔（Cowboy Bebop）》（又译《赏金猎人》）里的眼药毒品{Red Eye（红眼）}，喷到眼睛里会让眼睛变红，感知时间变慢，提高反应能力。",
    ...
    "Armor of Thorns": {
        ...
        locale: {
            ...
            notes: "获得时增加 1 个{{PICKUP:Armor}}，免疫碰撞伤害，7 倍翻滚伤害（从原来的3变成21）。\r\n如果同时拥有{{ITEM:Live Ammo}}，翻滚伤害提升为 105。如果同时拥有{{ITEM:Blast Helmet}}，翻滚伤害提升为 63。如果这 2 个同时拥有，翻滚伤害提升为 315。",
            trivia: "引用自《Dark Souls（黑暗之魂）》的Knight Kirk（针刺骑士寇克），他可以通过翻滚对敌人造成伤害：\r\n[(~data/Knight_Kirk.jpg)]",
    ...
    "Rat Boots": {
        ...
        locale: {
            ...
            trivia: "引用自《塞尔达传说：时之笛（The Legend of Zelda: Ocarina of Time）》的悬浮靴（Hover Boots），外形很像，效果也类似。\r\n[(~~data/Hover_Boots.png)]",
    ...
    "Magazine Rack": {
        ...
        locale: {
            ...
            notes: "使用后制造一个圆形区域，在该范围内所有枪无限弹药。一小段时间后区域消失。\r\n- 对{{GAME_MODE:Winchester's Game}}的{{GUN:Prize Pistol}}有效。\r\n- 对光束类的枪无效，仍然会消耗弹药。",
    ...
    "Charm Horn": {
        ...
        locale: {
            ...
            trivia: "引用自《指环王（The Lord of the Rings）》刚铎（Gondor）的号角。\r\n物品简介“使命召唤（The Call Of Duty）”引用自呼叫同志们支援国家的经典用语。",
    ...
    "Cog of Battle": {
        ...
        locale: {
            ...
            notes: "装弹时有精准装弹判断条，如果能在标志处准确触发完成装弹操作（再次发出装弹命令或者开火），弹夹中的子弹增加 75% 伤害和精准度。\r\n精准装弹失败会增加装弹时间。\r\n换枪会失去加成效果。\r\n{{GUN:Blasphemy}}的隐藏弹夹被判定为无限弹夹，精准装弹成功后，只要不换枪或重新装弹，将一直获得加成效果。",
    ...
    Honeycomb: {
        ...
        locale: {
            ...
            name: "蜂窝",
            tips: "受伤时生成蜜蜂攻击敌人。",
            trivia: "引用自《泰拉瑞亚（Terraria）》的{蜂窝（Honey Comb）}，一样的效果，受伤时释放小蜜蜂自动攻击周围的敌人。",
    ...
    "Gungeon Blueprint": {
        ...
        locale: {
            ...
            notes: "获得后所有关卡都会显示完整地图，包括{{ROOM:Secret Room}}。\r\n不会显示{{CHAMBER:Resourceful Rat's Lair}}的地板门。",
    ...
    "White Guon Stone": {
        ...
        locale: {
            ...
            trivia: "{{SYSTEM:Guon Stones}}引用自《龙与地下城》的{伊奥恩之石（Ioun Stone）}，这些魔法石能在主人的头顶上漂浮着，赋予他们各种特殊的力量。",
    ...
    "Blue Guon Stone": {
        ...
        locale: {
            ...
            trivia: "物品简介“于我有利（On My Side）”引用自成语“time is on my side”，即“天时地利”中的“天时”。\r\n{{SYSTEM:Guon Stones}}引用自《龙与地下城》的{伊奥恩之石（Ioun Stone）}，这些魔法石能在主人的头顶上漂浮着，赋予他们各种特殊的力量。",
    ...
    "Super Hot Watch": {
        ...
        locale: {
            ...
            trivia: "引用自游戏《燥热（Superhot）》，玩家在游戏中扮演一个特工，任务就是杀敌，游戏特色是你每行动一步世界才跟着动，你不动世界就变得异常缓慢，和进入子弹时间一般。\r\n物品简介“超超超超级！！！！（Suuuuuuper）”引用自该游戏过关时都会鬼畜循环“SUPERHOT”的文字和配音。",
            keyword: "chaojiredeshoubiaochaorerebiao cjrdsb cr rb 超級熱的手表 超熱 熱表 超热 热表",
            unlock: "同时拥有 5 个{{SYSTEM:Master Round}}（可以重复，如 2 个{{ITEM:Master Round I}}，拿到{{ITEM:Clone}}比较容易达成条件。也可以通过{{GAME_MODE:Boss Rush}}解锁，关卡有多个BOSS，只要打败一个就能获得{{SYSTEM:Master Round}}。"
        },
        sell: 54,
        colors: "yellow,white,black",
        shapes: "circle"
    ...
    "Wax Wings": {
        ...
        locale: {
            ...
            trivia: "引用自希腊神话，{伊卡洛斯（Icarus）}与父亲{代达洛斯（Daedalus）}使用蜡造的翅膀逃离克里特岛。",
    ...
    "Monster Blood": {
        ...
        locale: {
            ...
            name: "怪物血",
            tips: "增加 1 个{{SYSTEM:Heart Container}}。\r\n{免疫}((中毒))伤害，受伤时留下一大滩毒。",
            trivia: "引用自美国作家{R.L.斯坦（R. L. Stine）}所著惊险小说《鸡皮疙瘩（Goosebumps）》系列之《怪兽之血（Monster Blood）》。\r\n物品说明“无国界医生”引用自非牟利团体“无国界医生组织”，调皮地改成了“无证件医生”。",
    ...
    "Seven-Leaf Clover": {
        ...
        locale: {
            ...
            trivia: "引用自美国搞笑动画片《飞出个未来（Futurama）》第三季第四集“弗莱的运气（The Luck of the Fryrish）”：\r\n- 物品引用自主角弗莱（Philip J.Fry）的幸运七叶草（Seven Leaf Clover），一个可以给他带来好运的东西。\r\n- {{SYNERGY:Breakfast Club}}引用自该集中弗莱把幸运七叶草藏在《早餐俱乐部（The Breakfast Club）》的电影录像带里。\r\n- 和{{GUN:Wind Up Gun}}组合引用自另外一集“War Is the H-Word”里的发条枪（wind-up gun）。\r\n[(~data/Seven_Leaf_Clover.jpg)]",
            keyword:
                "qiyexingyuncaosiyecaoqiyecao qyxyc syc qyc 七葉幸運草 四葉草 七葉草 四叶草 七叶草",
            unlock: "在{{GAME_MODE:Winchester's Game}}中击碎所有头像 3 次，回到{{PAGE:The Breach}}和{{NPC:Winchester}}对话解锁"
        },
        sell: 54,
        colors: "green",
        shapes: "circle",
    ...
    "Number 2": {
        ...
        locale: {
            ...
            notes: "队友死亡后增加 2 移速和 41% 伤害。（单人模式下也可以获得加成效果）\r\n{{GUNGEONEER:The Cultist}}的初始被动道具，如果其他角色获得，可以带进角色的{{CHAMBER:The Past}}。\r\n获得后无法丢弃。\r\n非解锁{{GUN:Finished Gun}}的必要条件。",
            trivia: "引用自《爆炸头武士（Afro Samurai）》主角的头带，主角 Afro Samurai 是排名第二的战士（Number 2），为了手刃杀父仇敌 Justice——世界上最强的战士，并夺回父亲的头巾“Number 1”，踏上了漫漫征途。\r\n[(~data/Number_2_Afro_Samurai.jpg)]",
    ...
    "Uranium Ammolet": {
        ...
        locale: {
            ...
            notes: "{{PICKUP:Blank}}有几率使敌人((中毒))。\r\n每层开始时多给一个{{PICKUP:Blank}}。\r\n- {{ITEM:Owl}}{{ITEM:Clown Mask}}（粉眼小丑）{{ITEM:Blank Bullets}}也可以触发该效果。",
            trivia: "物品介绍引用自{居里夫人（Marie Curie）}，在放射性的研究上做出了杰出贡献，由于长期接触放射性物质，于1934年7月4日因恶性白血病逝世。",
    ...
    "Heart Locket": {
        ...
        locale: {
            ...
            name: "心形小盒",
            tips: "增加 1 个{{SYSTEM:Heart Container}}。\r\n{{GUNGEONEER:The Robot}}获得时，{{SYSTEM:Heart Container}}折算为 5~10{{PICKUP:Shell}}。\r\n回收时作为{{QUALITY:B}}品质道具。",
            trivia: "物品简介“死的警告（Memento Mori）”是拉丁语词组，意思为“勿忘人终有一死”，是中世纪拉丁语理论及对死亡率的反思习惯，常用来警惕尘世虚幻与短暂物质追求。",
    ...
    "Sixth Chamber": {
        ...
        locale: {
            ...
            trivia: "在西方文化中，666是不吉祥的数字，《圣经·启示录》中，666表示兽名数目，是魔鬼的数字，与撒旦或反基督有关，甚至产生了666恐惧症。444则是天使数字，幸运数字。\r\n（在中国刚好相反，6有一帆风顺的意思（六六大顺），是吉利、幸运数字，4因谐音“死”，是不吉利的数字。网络时代，6因谐音“溜”，666或者更多6表示很厉害。）",
    ...
    "Muscle Relaxant": {
        ...
        locale: {
            ...
            trivia: "引用自《合金装备》系列里的肌肉松弛药物，如安定剂（Diazepam）、镇静剂（Pentazemin）。",
    ...
    Sponge: {
        ...
        locale: {
            ...
            trivia: "物品简介“敬虔（Godliness）”引用自俗语“Cleanliness is next to Godliness（洁净近虔敬）”，意思是清洁仅次于圣洁，清洁是一种美德。\r\n\r\n可以听懂{{NPC:Professor Goopton}}的话引用自《哆啦A梦》里的{翻译魔芋}。\r\n[(~data/Translation_konjak.jpg)]",
    ...
    "Shelleton Key": {
        ...
        locale: {
            ...
            notes: "打开上锁的门和{{SYSTEM:Chest}}不需要消耗{{PICKUP:Key}}。\r\n增加 1 点{{SYSTEM:Curse}}。\r\n- 不能打开需要{{ITEM:Gnawed Key}}打开的{{CHAMBER:Resourceful Rat's Lair}}入口地板门和{{CHEST:Rat Chest}}。",
            trivia: "道具名{Shelleton Key}是{{ENEMY:Shelleton}}{Shelleton}和{Skeleton key（万能钥匙）}的混合词。",
    ...
    Owl: {
        ...
        locale: {
            ...
            notes: "当敌人的子弹接近时，会触发小范围{{PICKUP:Blank}}效果。\r\n偶尔发射一颗子弹随机攻击一个敌人。\r\n环绕玩家，可以抵挡子弹。\r\n- 触发的小{{PICKUP:Blank}}效果不能打开{{ROOM:Secret Room}}。\r\n- 触发的小{{PICKUP:Blank}}效果可以触发{{SYSTEM:Ammolet}}。\r\n- 发射的子弹受子弹被动影响。",
            trivia: "引用自《杀戮地带:暗影坠落（Killzone:Shadow Fall）》的{猫头鹰无人机（OWL Drone）}，会攻击敌人和保护玩家。",
    ...
    "Gold Junk": {
        ...
        locale: {
            ...
            notes: "拾取后获得 500{{PICKUP:Shell}}，金坷垃！\r\n- 如果拥有{{ITEM:Ser Junkan}}，{{ITEM:Ser Junkan}}会直接进化成机甲战士形态[(~~data/Ser_Junkan_Golden.png)]。\r\n- 和普通的{{ITEM:Junk}}一样可以增加{{GUNGEONEER:The Robot}}5% 伤害。",
            trivia: "物品简介“吾之蜜糖（One Man's Trash）”引用自俗语“one man's trash is another man's treasure（彼之砒霜，吾之蜜糖）”。",
            keyword: "jinlajijinkela jlj jkl 金垃圾 金坷垃 金坷垃",
            unlock: "摧毁任意{{CHEST:Red Chest}}{{CHEST:Black Chest}}{{CHEST:Rainbow Chest}}解锁（已打开的或变成宝箱怪的也可以）。\\n注意是解锁，不是摧毁这几种宝箱必出{{ITEM:Gold Junk}}，解锁后摧毁任意宝箱都有概率掉落。"
        },
        sell: 0,
        colors: "brown,yellow",
        shapes: "rect"
    ...
    "Chicken Flute": {
        ...
        locale: {
            ...
            notes: "召唤一只鸡神跟随玩家，抵挡子弹，并对碰撞到的敌人造成 2.5 伤害。\r\n受到一定伤害会呼叫鸡神军团攻击敌人。\r\n- 在带电的水上可以快速触发鸡群效果。\r\n- {{ITEM:Shock Rounds}}的电链会对鸡神造成伤害。",
            trivia: "引用自《塞尔达传说》系列，如果攻击一只{库克鸡（Cucco）}3 次，就会出现一大群库克鸡攻击玩家。\r\n图标引用自该游戏系列中的{精灵之笛（Fairy Ocarina）}。",
    ...
    "Briefcase of Cash": {
        ...
        locale: {
            ...
            notes: "获得的 250{{PICKUP:Shell}}和 3{{PICKUP:Hegemony Credit}}。\r\n- 获得的奖励永久生效，也就是说，你可以把它卖了获得额外的 41{{PICKUP:Shell}}。",
    ...
    "Riddle of Lead": {
        ...
        locale: {
            ...
            notes: "+1 个{{SYSTEM:Heart Container}}，并回满{{PICKUP:Heart}}。\r\n+30% 伤害，+10% 移速，+15% 翻滚速度。\r\n当血量 ≤1 个{{PICKUP:Heart}}时，有 50% 概率抵消伤害。\r\n- {{GUNGEONEER:The Robot}}获得时会一直有 50% 概率抵消伤害。\r\n- 丢出重新拾取，不会重复获得治疗。\r\n- 伤害抵消对掉落伤害有效。\r\n- 伤害抵消只是不掉血，还是会有受伤判定。如果在BOSS战中触发，虽然没有掉血，但也无法获得{{SYSTEM:Master Round}}。",
            trivia: "引用自 1982 年的魔幻电影《野蛮人柯南（Conan the Barbarian）》中的“Riddle of Steel（钢铁之谜）”。",
    ...
    "Bracket Key": {
        ...
        locale: {
            ...
            trivia: "汉化翻车现场，“Bracket Key”应该作为一个词组翻译为“括号键”而不是拆开直译成“支架钥匙”。\r\n该道具引用自本游戏开发组自己的开发过程。为了便于调试，开发小哥使用键盘上的“]”键来自动清空房间并阻止生成新的敌人。",
    ...
    "Red Crown": {
        id: 1002,
        name: "Red Crown",
        icon: "item/Red_Crown.png",
        type: "Passive",
        quality: "N",
        locale: {
            type: "被动",
            name: "红眼冠",
            tips: "联动期间，打开第一膛室门口的{{CHEST:Crossover Chest}}掉落。捡起后角色变身为{{GUNGEONEER:The Lamb}}，且该道具不可丢弃。\n可提供一次复活机会，复活血量为2颗心{{PICKUP:Heart}}{{PICKUP:Heart}}。",
            notes: '= [[span class="phone-only-content"]]**移动端独有内容：**本页面仅适用于**移动端版本挺进地牢**[[/span]]\n\n= ※《咩咩启示录》限时联动道具，仅在联动期间可以使用\n> //“我会赐你新生命，但你必须付出代价！”//\n> //高贵的饰品，适合一教之主佩戴。//\n联动期间，打开第一膛室门口的{{CHEST:Crossover Chest}}掉落。捡起后角色变身为{{GUNGEONEER:The Lamb}}，且该道具不可丢弃。\n可提供一次复活机会，复活血量为2颗心{{PICKUP:Heart}}{{PICKUP:Heart}}。',
            trivia: "{{ITEM:Red Crown}}在《咩咩启示录》中是待终冠主赐给{{GUNGEONEER:The Lamb}}的圣器\n[(~trivia/Red_Crown_Original.png)]\n{{ITEM:Red Crown}}复活了{{GUNGEONEER:The Lamb}}，并且在必要时刻会化为武器，讨伐异端。"
        },
        sell: 0,
        colors: "red,black",
        shapes: "other"
