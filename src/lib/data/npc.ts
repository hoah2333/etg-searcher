export default {
	...
	"Frifle and the Grey Mauser": {
		...
		locale: {
			...
			trivia:
				"引用自{Fafhrd 和 Gray Mouser}（美国作家 Fritz Leiber 作品中的两个英雄），{Frifle}是一个双关语，包含术士（Fafhrd）和步枪（Rifle）之意，{Grey Mauser}也引用自Mauser（一个德国枪械制造商）。\r\n官方{{PAGE:Comic}}解释了 Frifle 和 Grey Mauser 为何进入地牢，他们因为一些意外，来到地牢的目的是想要抹掉过去。"
		}
	},
	Frifle: {
		id: 8,
	...
	"Gunsling King and Manservantes": {
		...
		locale: {
			...
			trivia:
				"{Manservantes}是 Manservant 和 Cervantes 的复合词，引用自{Miguel de Cervantes}（一个西班牙浪漫主义作家）。"
		}
	},
	"Gunsling King": {
		id: 12,
	...
	"Ledge Goblin": {
		...
		locale: {
			...
			notes:
				"从{{CHAMBER:Gungeon Proper}}解救后来到{{PAGE:The Breach}}，坐在快捷电梯房前面的悬崖边缘，旁边放着她的头盔。\r\n和她的头盔互动，会把头盔踢下悬崖，然后她会跑到{{ROOM:Gungeon}}里找头盔，你需要重新救她，当她第四次回到{{PAGE:The Breach}}，她会给你解锁{{ITEM:Blast Helmet}}，然后机智的用链子把头盔连在地板上，你再也没办法把头盔踢下去了。"
		}
	},
	Blacksmith: {
		id: 20,
	...
	Sorceress: {
		...
		locale: {
			...
			notes:
				"击败{{BOSS:High Dragun}}后，{{NPC:Sorceress}}会出现在某关卡的牢房中，解救后出现在{{PAGE:The Breach}}右上角的房间中。\r\n和她对话，缴纳 6{{PICKUP:Hegemony Credit}}后会获得一个祝福，下一次进入地牢为{{GAME_MODE:Blessing Mode}}。"
		}
	},
	Tonic: {
		id: 29,
	...
	"Patches and Mendy": {
		...
		locale: {
			...
			notes:
				"偶尔出现在{{ROOM:Gungeon}}的一种特殊房间，搭着一个破帐篷，和右边的护士小姐姐对话可以回满{{PICKUP:Heart}}。\r\n{{GUNGEONEER:The Robot}}则是给一个{{ITEM:Junk}}或{{ITEM:Bottle}}或{{PICKUP:Armor}}。\r\n她们只会帮你治疗一次。\r\n如果{{SYSTEM:Curse}}达到 10 点，引出了{{ENEMY:Lord of the Jammed}}，护士小姐姐在帮你治疗的过程中，它依然会向你攻击造成伤害，这种情况最好跑远点再传送过来治疗。",
			trivia:
				"护士小姐姐的治疗方式是拿个装着小精灵的瓶子砸碎在你头上，引用自《塞尔达传说（Legend of Zelda）》系列，玩家可以使用装在瓶子里的小精灵恢复生命值。"
		}
	},
	Synergrace: {
		id: 32,
		...
		locale: {
			...
			notes:
				"偶尔出现在{{ROOM:Gungeon}}的一种特殊房间，摆着两台老虎机，和她对话可以使用{{PICKUP:Shell}}购买一个{{CHEST:Synergy Chest}}。\r\n购买 3 次{{CHEST:Synergy Chest}}会解锁{{ITEM:Macho Brace}}。\r\n当你拥有的枪没有任何组合时，她不会卖你{{CHEST:Synergy Chest}}。"
		}
	},
	Vampire: {
		id: 33,
