export default {
    ...
    "Synergy Chest": {
        ...
        locale: {
            ...
            notes: "打开时会在 <span style='color:red'>红色</span> 和 <span style='color:blue'>蓝色</span> 间不断变换，变换结束后，如果是 <span style='color:red'>红色</span>，会随机掉落一个道具或枪，如果是 <span style='color:blue'>蓝色</span>，会掉落一个可以和玩家拥有的道具或枪形成{{SYSTEM:Synergy}}的道具或枪。\r\n开出的道具或枪品质随机。\r\n组合宝箱偶尔会替换普通宝箱出现，并经常带有{导火索}，也可以在{{NPC:Synergrace}}购买。\r\n组合宝箱不会变成{{ENEMY:Mimic}}，即使玩家拥有{{ITEM:Mimic Tooth Necklace}}。"
        }
    },
    "Rat Chest": {
        name: "Rat Chest",
