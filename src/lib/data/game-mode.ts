export default {
	...
	"Curse Mode": {
		...
		locale: {
			...
			notes:
				"角色{{SYSTEM:Kill The Past}}后，解锁该角色的{诅咒模式}。\r\n进入{{ROOM:Gungeon}}，如果和第一关第一个房间的{{SHRINE:Hero}}对话，会直接把{{SYSTEM:Curse}}设置为 9，让地牢之旅更加刺激。"
		}
	},
	"Blessing Mode": {
		name: "Blessing Mode",
	...
	"Turbo Mode": {
		...
		locale: {
			...
			notes:
				"和{{NPC:Tonic}}对话可以开启{加速模式}，游戏速度加快\r\n可以和{系统菜单 > 选项 > 游戏 > 非战斗模式下速度加快}效果叠加，跑得飞快。\r\n在角色的过去任务关卡中无效。\r\n开启{加速模式}后，地图的右上角会出现{{NPC:Tonic}}的头像。"
		}
	},
	"Challenge Mode": {
		name: "Challenge Mode",
