export default {
    ...
    Blank: {
        ...
        locale: {
            ...
            trivia: "雕像形象是{{NPC:Old Red}}，他偶尔会出现在{{ROOM:Gungeon}}，卖一些{{PICKUP:Blank}}相关的物品。"
        }
    },
    Blood: {
        id: 4,
        ...
        locale: {
            ...
            trivia: "引用自电影《夺宝奇兵2之魔宫传奇（Indiana Jones and the Temple of Doom）》，失去{{SYSTEM:Heart Container}} 引用自 Mola Ram 挖出祭品的心脏，对话“Kaliber Mah Shakti De”引用自台词“Kali Ma Shakti De”。"
        }
    },
    Challenge: {
        id: 5,
    ...
    Companion: {
        ...
        locale: {
            ...
            trivia: "出现在雕像里的同伴有：<g>{{ITEM:Super Space Turtle}}{{ITEM:Blank Companion's Ring}}{{ITEM:Baby Good Mimic}}{{ITEM:R2G2}}{{ITEM:Pig}}{{ITEM:Wolf}}{{ITEM:Dog}}{{ITEM:Badge}}</g>"
        }
    },
    Dice: {
        id: 8,
    ...
    Beholster: {
        ...
        locale: {
            ...
            notes: "献祭{{BOSS:Beholster}}使用的 6 把枪（可分多局游戏给）：\r\n<g>{{GUN:Com4nd0}}{{GUN:M1911}}{{GUN:Void Marshal}}{{GUN:Machine Pistol}}{{GUN:Eye of the Beholster}}{{GUN:Trank Gun}}</g>\r\n集齐后，{{SHRINE:Beholster}}会把 6 把枪还给你，并获得{{SYNERGY:Behold!}}效果。"
        }
    },
    Lamb: {
        id: 201,
        name: "Lamb",
        icon: "shrine/Lamb_Shrine.png",
        locale: {
            name: "圣羊雕像",
            tips: "《咩咩启示录》限时联动期间，第一膛室入口的{{SHRINE:Hero}}会变为{{SHRINE:Lamb}}。",
            notes: '= [[span class="phone-only-content"]]**移动端独有内容：**本页面仅适用于**移动端版本挺进地牢**[[/span]]\n\n《咩咩启示录》限时联动期间，第一膛室入口的{{SHRINE:Hero}}会变为{{SHRINE:Lamb}}。互动后显示：\n> 一座神秘的圣像。\n> 有一段铭文\n> //苦难将化为胜利；以往死去的，如今将攫食。//\n> 其余的都被磨损了。\n 无特殊效果。',
            trivia: "原型为《咩咩启示录》中满级的圣像。\n[(~trivia/Lamb_Shrine_Original.png)]"
        }
    }
};
