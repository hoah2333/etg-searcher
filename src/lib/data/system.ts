export default {
	...
	"Save Game": {
		...
		locale: {
			...
			notes:
				"每个关卡过关后才能存档，存档后会退出到主界面，{继续}游戏会直接从下一关开始。详情见{{NPC:Save Button}}。"
		}
	},
	DLC: {
		id: 6,
	...
	"Kill The Past": {
		...
		locale: {
			...
			notes:
				"携带{{ITEM:The Bullet That Can Kill The Past}}使用{{GUN:The Gun That Can Kill The Past}}通关（不进入{{CHAMBER:Bullet Hell}}），可以进入角色的过去关卡，抹掉过去。\r\n进入过去关卡会失去所有的枪和道具（除了{{ITEM:Galactic Medal of Valor}}{{ITEM:Enraging Photo}}），重新获得特定的初始枪和道具，不过{{PICKUP:Blank}}{{PICKUP:Armor}}会保留。"
		}
	},
	Synergy: {
		id: 8,
	...
	"Evil Muncher": {
		...
		locale: {
			...
			notes:
				"常见于{{CHAMBER:Bullet Hell}}和骷髅头形状的{{ROOM:Secret Room}}，小概率替换{{SYSTEM:Muncher}}出现在商店\r\n\r\n第一次使用时，它会吃掉 10 把枪（可多局游戏分期付款），然后吐出{{GUN:Gunslinger's Ashes}}，并解锁该枪\r\n之后再使用，会吞食随机数量的枪，有 25% 概率给{{QUALITY:S}}品质的枪，75% 概率给{{QUALITY:A}}品质的枪"
		}
	},
	Mirror: {
		id: 19,
		...
		locale: {
			...
			trivia:
				"魔镜引用自《哈利·波特与魔法石》中的{厄里斯魔镜（the Mirror of Erised）}，一个未上锁的宝箱将勾起玩家最大的欲望。\r\n打碎镜子增加诅咒值引用自民间传说{打碎镜子将带来七年厄运}（3.5=7 x 0.5）。"
		}
	},
	"Cursed Pot": {
		id: 20,
	...
	"Advanced Dragun": {
		...
		locale: {
			...
			notes:
				"带着{{SYSTEM:Serpent}}进入{{BOSS:High Dragun}}BOSS 房，小蛇会叛变，跟在枪龙旁边朝玩家发射子弹。枪龙第二阶段会抓住小蛇，变成金枪龙，进入第三阶段。"
		}
	},
	"Rescue NPCs": {
		id: 27,
	...
	"The Bullet That Can Kill The Past's Parts": {
		...
		locale: {
			...
			notes:
				"已收集的{{ITEM:The Bullet That Can Kill The Past}}的部件会摆放在这里：\r\n<g>{{ITEM:Prime Primer}}{{ITEM:Arcane Gunpowder}}{{ITEM:Planar Lead}}{{ITEM:Obsidian Shell Casing}}</g>\r\n\r\n击败{{SYSTEM:Advanced Dragun}}后，台子会变成金色龙头。"
		}
	},
	"co-op": {
		id: 31,
	...
	"Re-Armed": {
		...
		locale: {
			...
			notes:
				"运送{{NPC:Ox}}的备用手臂任务，完成后解锁{{ITEM:Clone}}，详情见{{NPC:Ox and Cadence}}。"
		}
	},
	"Cell And Key": {
		id: 40,
		...
		locale: {
			...
			notes:
				"{{ROOM:Gungeon}}中关着NPC的牢房，需要在牢房所在关卡获得特殊的牢房钥匙打开，大部分NPC被救出后会来到{{PAGE:The Breach}}，部分救出后可在{{ROOM:Gungeon}}中遇到。详情见{{PICKUP:Cell Key}}。"
		}
	},
	"Brick of Cash": {
		id: 41,
		...
		locale: {
			...
			notes:
				"拥有{{ITEM:Brick of Cash}}时，{{ROOM:Secret Room}}入口会有出现一个[(~~data/Brick_of_Cash_baby.png)]提示位置。"
		}
	},
	Insight: {
		id: 42,
		...
		locale: {
			...
			notes:
				"拥有{{SYNERGY:Insight}}时，{{ROOM:Secret Room}}入口会有出现一个[(~~synergy/Insight.png)]提示位置。"
		}
	},
	"Master Round": {
		id: 43,
